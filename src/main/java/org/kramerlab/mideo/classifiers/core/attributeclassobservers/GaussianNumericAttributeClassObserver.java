 ...
 *    
 */
package org.kramerlab.mideo.classifiers.core.attributeclassobservers;
...
/**
 * Class for observing the class data distribution for a numeric
 * attribute using gaussian estimators. This observer monitors the class
 * distribution of a given attribute. Used in naive Bayes and decision
