 ...
 *
 */
package org.kramerlab.mideo.classifiers.bayes;
 ...
 *
 * <p>Performs classic bayesian prediction while making naive assumption
 * that all inputs are independent. Naive Bayes is a classiﬁer algorithm
 * known for its simplicity and low computational cost. Given n
 * different classes, the trained Naive Bayes classiier predicts for
 * every unlabelled instance I the class C to which it belongs with high
 * accuracy.</p>
 *
